...
public class EmployeeHours extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    tvOM.setText(dataSnapshot.child("OM").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OM").setValue("00:00");}
                try {
                    tvCM.setText(dataSnapshot.child("CM").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CM").setValue("00:00");}
                try {
                    tvOT.setText(dataSnapshot.child("OT").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OT").setValue("00:00");}
                try {
                    tvCT.setText(dataSnapshot.child("CT").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CT").setValue("00:00");}
                try {
                    tvOW.setText(dataSnapshot.child("OW").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OW").setValue("00:00");}
                try {
                    tvCW.setText(dataSnapshot.child("CW").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CW").setValue("00:00");}
                try {
                    tvOTh.setText(dataSnapshot.child("OTh").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OTh").setValue("00:00");}
                try {
                    tvCTh.setText(dataSnapshot.child("CTh").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CTh").setValue("00:00");}
                try {
                    tvOF.setText(dataSnapshot.child("OF").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OF").setValue("00:00");}
                try {
                    tvCF.setText(dataSnapshot.child("CF").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CF").setValue("00:00");}
                try {
                    tvOS.setText(dataSnapshot.child("OS").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OS").setValue("00:00");}
                try {
                    tvCS.setText(dataSnapshot.child("CS").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CS").setValue("00:00");}
                try {
                    tvOSu.setText(dataSnapshot.child("OSu").getValue().toString());
                } catch (NullPointerException NPE){reff.child("OSu").setValue("00:00");}
                try {
                    tvCSu.setText(dataSnapshot.child("CSu").getValue().toString());
                } catch (NullPointerException NPE){reff.child("CSu").setValue("00:00");}
            }
    ...
    public void closed (TextView open, TextView close, CheckBox y, String idO, String idC){
        ...
        if (y.isChecked()){
            ...
            open.setText("00:00");
            close.setText("00:00");
            reff.child(idC).setValue("00:00");
            reff.child(idO).setValue("00:00");
        }
